...
namespace ql_nhanSW.Migrations
{
    ...
    [Migration("20260401162115_UpdateLuongRelationship")]
    partial class UpdateLuongRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ql_nhanSW.Models.Luong", b =>
                {
            ...
            modelBuilder.Entity("ql_nhanSW.Models.NghiPhep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ql_nhanSW.Models.TaiKhoanVaiTro", b =>
                {
                    b.Property<int>("MaTaiKhoan")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ql_nhanSW.Models.VaiTro", b =>
                {
                    b.Property<int>("MaVaiTro")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ql_nhanSW.Models.TaiKhoanVaiTro", b =>
                {
                    b.HasOne("ql_nhanSW.Models.TaiKhoan", "TaiKhoan")
                        .WithMany("TaiKhoanVaiTro")
                        .HasForeignKey("TaiKhoanMaTaiKhoan");

                    b.HasOne("ql_nhanSW.Models.VaiTro", "VaiTro")
